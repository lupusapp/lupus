...
#define header_getter(aclass, bclass, name, type)                              \
    type CONCAT(lupus_, aclass, _get_, name)(Lupus##bclass * instance)
#define header_setter(aclass, bclass, name, type)                              \
    void CONCAT(lupus_, aclass, _set_, name)(Lupus##bclass * instance,         \
                                             type name)
...
#define setter(aclass, bclass, name, type)                                     \
    header_setter(aclass, bclass, name, type) {                                \
        g_object_set(instance, #name, name, NULL);                             \
    }
