...
gint main(gint argc, gchar **argv)
{
    ...
    gboolean lupus_tox_dir_exists = g_file_test(LUPUS_TOX_DIR, G_FILE_TEST_EXISTS | G_FILE_TEST_IS_DIR); // NOLINT
    g_return_val_if_fail(lupus_tox_dir_exists, 1);
    ...
    gint res = g_application_run(G_APPLICATION(lupus_application_new()), argc, argv);
